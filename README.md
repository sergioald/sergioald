...
- Applied AI for sensor-rich engineering systems
...
- Model validation, testing, documentation and CI
...
**AI / Data Science:** machine learning, anomaly detection, time-series modelling, model validation, feature engineering  
**Research Software:** Python packaging, testing, CI, documentation, reproducible workflows  
**Engineering Systems:** digital twins, sensor data, hydraulic systems, scientific modelling, simulation outputs  
